                    ...
                    <form action="">
                        <div class="header-search">
                            <input class="search-input" type="search"
                                   placeholder="Каких студентов вы ищете?">
                            <button onclick="window.location.href='#applications'" class="search-btn" type="submit">
                                Найти
                            </button>
                        </div>
                    </form>
        ...
        <div class="container">
            <div class="application-content">
                ...
                <div>
                    <aside class="application-filters">
                        ...
                        <article class="filter-type salary">
                            ...
                            <div class="filter-choose">
                                <div>
                                    <input id="from0" type="radio" name="salary">
                                    <label for="from0">От 0 руб.</label>
                                </div>
                                <div>
                ...
                <section class="application-container">
                    ...
                    @endif
                    @if(Auth::user()->type_user == "Компания")
                        <h2 class="application-title">Count студентов</h2>
                    @endif
