                ...
                <div class="card">
                    ...
                    <div class="card-body" id="companyForm">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="name"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Название компании') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="phone"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Контактный телефон') }}</label>

                                <div class="col-md-6">
                                    <input id="phone" type="tel"
                                           class="custom-input @error('phone') is-invalid @enderror" name="phone"
