                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           class="custom-input @error('name') is-invalid @enderror" name="name"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text"
                                           class="custom-input @error('surname') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="patronymic" type="text"
                                           class="custom-input @error('patronymic') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           class="custom-input @error('email') is-invalid @enderror" name="email"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="course" type="number"
                                           class="custom-input @error('course') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="group" type="text"
                                           class="custom-input @error('group') is-invalid @enderror" name="group"
